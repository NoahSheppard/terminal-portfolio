(function () {
    ...
    function initTerminal() {
        ...
        const desktopState = { running: false };
        ...
        function startDesktop() {
            if (desktopState.running) {
                term.writeln("desktop: already running");
                return;
            }
            if (!window.WebglApp || typeof window.WebglApp.start !== "function") {
                term.writeln("desktop: WebGL not available");
                return;
            }

            desktopState.running = true;
            setInputLock(true);
            term.writeln("Starting desktop...");
        ...
        const commandContext = {
            ...
            toFsUrl,
            startDesktop,
            isDesktopRunning: () => desktopState.running
        };
